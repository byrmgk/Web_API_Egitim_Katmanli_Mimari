...
namespace WebAPI.Utilities.Formatters
{
    public class CsvOutputFormatter : TextOutputFormatter
    {
        ...
        {
            //TOOD: MediaTypeHeaderValue  ifadeyi Microsoft.Net.Http.Headers çözmesine dikkat et 
            //TODO: Csv ifadesini oluşturmul olduk 
        ...
        public override async Task WriteResponseBodyAsync(OutputFormatterWriteContext context, Encoding selectedEncoding)
        {
            ...
            if (context.Object is IEnumerable<BookDto> bookDto)
            {
            ...
            else if (context.Object is IEnumerable<BookDto> books)
            {
